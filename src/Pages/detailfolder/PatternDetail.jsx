                ...
                {pattern ? (
                    pattern.including.map((item) => (
                        <div className="contents-article">
                            ...
                            {item.explane_img_1 ? (
                                <img src={require(`../../Sources/Img/${item.explane_img_1}`)} style={{maxWidth: "10%"}}></img>
                            ) : ""}
                            ...
                            {item.explane_img_2 ? (
                                <img src={require(`../../Sources/Img/${item.explane_img_2}`)} style={{maxWidth: "10%"}}></img>
                            ) : ""}
                            ...
                            {item.explane_img_3 ? (
                                <img src={require(`../../Sources/Img/${item.explane_img_3}`)} style={{maxWidth: "10%"}}></img>
                            ) : ""}
                            ...
                            {item.explane_img_4 ? (
                                <img src={require(`../../Sources/Img/${item.explane_img_4}`)} style={{maxWidth: "10%"}}></img>
                            ) : ""}
                        </div>
                    ))
                ) : ""}
